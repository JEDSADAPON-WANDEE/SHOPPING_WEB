...
?>
    ...
    <div class="container">
        ...
        <a onClick="window.location='product.php';" class="sidebar-items">
                All products
            </a>
            ...
            ?>
            <a onClick="window.location='product.php?pt=<?=$data2['cate_id'];?>';" class="sidebar-items">
                <?=$data2['cate_name'];?>
            </a>

            <?php } ?>
            <a onClick="window.location='product_insert.php';" class="sidebar-items">
                Insert Product
            </a>
...
?>
        <div onClick="window.location='product_detail.php?id=<?=$data['p_id'];?>';" class="product-items <?=$data['p_type'];?>">
